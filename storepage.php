    ...
    <div class="Wrp">
        <div class="bg-cpn">
            <div class="str-logo flex">
                <img src="./assets/images/superdry-logo.png" alt="">
            </div>
            <div class="bg-wrp">
                <div class="str-cntnt">
                    <h3>JD Sports Voucher Codes &<br> Free Shipping Deals</h3>
                    <p>JD Sports is the leading trainer and sports fashion retailer in the UK. </p>
                </div>
                <div class="site-wrp">
    ...
    <div class="Wrp">
                ...
                <div class="wdgt-sd">
                    ...
                    <div class="rltd-str">
                        ...
                        <div class="wrpr">
                            ...
                            <span class="ctg-lnk" role="button">Health & Beauty</span>
                            <span class="ctg-lnk" role="button">Pets</span>
                            <span class="ctg-lnk" role="button">Baby & Kids</span>
                            <span class="ctg-lnk" role="button">Electronics</span>
                            <span class="ctg-lnk" role="button">Internet</span>
                            <span class="ctg-lnk" role="button">Home & Garden</span>
                            <span class="ctg-lnk" role="button">Pets</span>
                            <span class="ctg-lnk" role="button">Home & Garden</span>
                            <span class="ctg-lnk" role="button">Health & Beauty</span>
        ...
        <div class="tbl-br">
            <table>
                ...
                <tr>
                    <td>10% Off Sitewide at Modibodi</td>
                    <td class="cntr">12th Jan 2021</td>
                    <td class="cntr">************</td>
                </tr>
                <tr>
                    <td>15% Off Sitewide at Modibodi</td>
                    <td class="cntr">12th Jan 2021</td>
                    <td class="cntr">************</td>
                </tr>
                <tr>
                    <td>Free AU Shipping On Order Over AU$120 at Modibodi </td>
                    <td class="cntr">12th Jan 2021</td>
                    <td class="cntr">************</td>
                </tr>
                <tr>
                    <td>Seamfree Air Boyleg for $24.50 at Modibodi</td>
                    <td class="cntr">12th Jan 2021</td>
                    <td class="cntr">************</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="tcntr" colspan="3"><i>Updated: 12/01/2021<i></td>
                </tr>
            </table>
        </div>
        <!-- Store Table <Component:<End> -->
...
<!-- Disclosure <Component : Start> -->
<?php include('disclosure.php'); ?>
